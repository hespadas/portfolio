...
export default function HomePage() {
  const globalKeywords = ["JavaScript", "Python", "TypeScript", "PHP"];
      ...
      <section className="relative py-16 rounded-2xl bg-gradient-to-br from-neutral-900 to-neutral-800 shadow-xl">
        <div className="max-w-3xl mx-auto text-center space-y-6 px-4">
          ...
          <p className="text-neutral-300 text-lg leading-relaxed">
            Hello, I'm Henrique. I specialize in backend development with
            expertise in Python, JavaScript and PHP. Passionate about creating
            efficient, scalable solutions.
          </p>
          <div className="flex flex-wrap justify-center gap-4 pt-4">
            <span className="px-3 py-1 text-sm bg-neutral-700 rounded-full text-neutral-200">
              Django
            </span>
            <span className="px-3 py-1 text-sm bg-neutral-700 rounded-full text-neutral-200">
              Odoo
          ...
          <div className="flex justify-center space-x-4 pt-2">
            <a
              href="https://github.com/hespadas/"
              className="p-3 text-neutral-300 hover:text-white transition-colors"
            >
              <FaGithub size={24} />
            </a>
            <a
              href="https://www.linkedin.com/in/henrique-espadas-paranhos/"
              className="p-3 text-neutral-300 hover:text-white transition-colors"
            >
              <FaLinkedin size={24} />
            </a>
